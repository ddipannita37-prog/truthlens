...
# The following line is commented out because it is causing the application to crash in the Cloud Run environment.
# The 'google.adk' package needs to be investigated to understand why it is failing.
